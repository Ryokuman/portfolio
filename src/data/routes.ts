...
const routeMap: Record<string, RouteEntry> = {
  ...
  // Projects
  "dc215fcc-d29e-4c8d-830c-e08d5f9cbccc": { type: "project", projectId: "dynamos-platform" },
  "50f1bfce-7c0c-4842-a854-997fe56b0b99": { type: "project", projectId: "new-human-orchestrator" },
  "dc1511f0-c537-459b-a548-a2a3599928a0": { type: "project", projectId: "stackstory" },
  ...
  // DynaMOS Platform details
  "4160b107-4888-4fab-aca9-8e7330ef4cc9": { type: "detail", projectId: "dynamos-platform", detailIndex: 0 },
  "30314bf9-55d0-498c-9378-ef421b937903": { type: "detail", projectId: "dynamos-platform", detailIndex: 1 },
  "157d142d-883b-4fae-8a54-9dc8ed4161c2": { type: "detail", projectId: "dynamos-platform", detailIndex: 2 },
  "1a3c7912-4e70-4a4a-82f9-d1150153a535": { type: "detail", projectId: "dynamos-platform", detailIndex: 3 },

  // New-Human Orchestrator details
  "9a86756b-709c-4277-a101-3140c728da78": { type: "detail", projectId: "new-human-orchestrator", detailIndex: 0 },
  "27cc90b6-bade-427c-83ed-7b23189e4c7f": { type: "detail", projectId: "new-human-orchestrator", detailIndex: 1 },
  "2b2798d3-332f-46df-b906-ee74c0fad38e": { type: "detail", projectId: "new-human-orchestrator", detailIndex: 2 },
  "fda42d88-36c5-4936-bf2c-06f80b181157": { type: "detail", projectId: "new-human-orchestrator", detailIndex: 3 },

  // StackStory details
  "29992f4c-bf83-4fca-9959-b67192917a74": { type: "detail", projectId: "stackstory", detailIndex: 0 },
  "b1c7d022-9fb3-4029-9b5a-f7960a15a119": { type: "detail", projectId: "stackstory", detailIndex: 1 },
  "234e9c09-1db8-42c3-85ad-a17a830837e2": { type: "detail", projectId: "stackstory", detailIndex: 2 },
  "403218dd-0cbe-4377-ba44-3ae180696f75": { type: "detail", projectId: "stackstory", detailIndex: 3 },
  ...
  "fe9b2e55-40cc-4d72-9354-17ad4d55f9d4": { type: "detail", projectId: "onjump", detailIndex: 2 },
  "27deae86-1b40-41a6-9bcf-1bc6ebb8b1db": { type: "detail", projectId: "onjump", detailIndex: 3 },
  ...
  "5025433a-210b-40bf-9f14-2e676916886e": { type: "detail", projectId: "quiza", detailIndex: 2 },
  "2e0d9cc7-b74b-4448-ad95-058ac58bacc1": { type: "detail", projectId: "quiza", detailIndex: 3 },
