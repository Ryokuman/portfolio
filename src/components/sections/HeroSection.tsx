  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-1/4 top-1/2 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl" />
      </div>
      ...
      >
        ...
        >
          <motion.div
            ...
            className="mx-auto h-10 w-6 rounded-full border-2 border-gray-700 p-1"
          >
